      ...
      <section id="team" className="members-section">
        ...
        <div className="members-container">
          {[
            ...
            { id: 2, name: "Shekhar Suman", position: "Co-Convener", img: "/2.jpg" },
            { id: 3, name: "Harsh Kumar Jha", position: "Co-Convener", img: "/3.jpg" },
            { id: 4, name: "Manish Kumar", position: "Co-Convener", img: "/4.jpg" },
            { id: 5, name: "Gaurav Kumar", position: "Co-Convener", img: "/5.jpg" },
            { id: 6, name: "Sonali Soni", position: "Co-Convener", img: "/6.jpg" }
          ].map((member) => (
